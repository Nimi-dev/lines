...
const KPAWN = {
  ...
  lines: [
    ...
    { t: "2.Bc4 — the bishop first.", base: ["e2e4","e7e5"], plies: [
      { m: "f1c4", san: "2.Bc4", note: "The bishop's opening — 55 of your games. Usually a scholar's-mate cousin in disguise." },
      { m: "g8f6", san: "2...Nf6!", note: "Counterattack e4 immediately — and notice: with the knight on f6, Qh5 is impossible forever. One move kills the whole circus." },
      { m: "d2d3", san: "3.d3", note: "His most common (23×): protecting e4, dreaming of a slow Italian." },
      { m: "c7c6", san: "3...c6!", note: "The point: prepare ...d5 and blunt the c4 bishop before it breathes." },
      { m: "g1f3", san: "4.Nf3", note: "" },
      { m: "d7d5", san: "4...d5!", note: "The full counter-strike: his proud bishop must retreat, you own the center, and every trade favors you." },
      { m: "c4b3", san: "5.Bb3", note: "" },
      { m: "f8d6", san: "5...Bd6", note: "Develop while guarding e5 — the bishop's best diagonal points at his king." },
      { m: "b1c3", san: "6.Nc3", note: "" },
      { m: "e8g8,h8f8", san: "6...O-O!", note: "Castled by move six with the better center and the freer game. SF: 0.00 — the bishop's opening, answered by a plan instead of a panic. Your plan from here: ...Re8, ...Nbd7-f8 or ...Bg4, and the d5/e5 duo decides the middlegame." },
    ] },
    { t: "2.Nc3 — the Vienna, with 3.f4.", base: ["e2e4","e7e5"], plies: [
      { m: "b1c3", san: "2.Nc3", note: "The Vienna — 33 of your games. It wants f4 next; you won't let it matter." },
      { m: "g8f6", san: "2...Nf6", note: "Develop and hit e4 — the universal answer." },
      { m: "f2f4", san: "3.f4", note: "The Vienna gambit try —" },
      { m: "d7d5", san: "3...d5!", note: "— met by the book counter-thrust. Never take on f4 here: strike the center while his king-side loosens." },
      { m: "f4e5", san: "4.fxe5", note: "" },
      { m: "f6e4", san: "4...Nxe4!", note: "The knight lands with tempo on the loose c3-knight and the f2-hole behind it. (If 3.Nf3 instead of f4, it's just the Four Knights — the next line.)" },
      { m: "g1f3", san: "5.Nf3", note: "" },
      { m: "f8c5", san: "5...Bc5!", note: "Aim at the hole his gambit dug: f2 is one diagonal away and his king hasn't castled." },
      { m: "d2d4", san: "6.d4", note: "The kick —" },
      { m: "c5b4", san: "6...Bb4!", note: "— sidestepped WITH a pin: c3 is attacked twice, e4 is yours, and ...Nxc3/...Qh4 ideas hang over him. SF: −0.17, Black comfortable and White already explaining. The Vienna's fire, doused by move six." },
    ] },
    { t: "3.Nc3 — the Four Knights.", base: ["e2e4","e7e5"], plies: [
      { m: "g1f3", san: "2.Nf3", note: "" },
      { m: "b8c6", san: "2...Nc6", note: "" },
      { m: "b1c3", san: "3.Nc3", note: "The Four Knights — 29 of your games, and the Vienna's 3.Nf3 transposes here too: one line, two move orders." },
      { m: "g8f6", san: "3...Nf6", note: "" },
      { m: "f1b5", san: "4.Bb5", note: "The Spanish Four Knights, the main try." },
      { m: "f8b4", san: "4...Bb4!", note: "Mirror him — the symmetric pin is fully sound, and the plans are simple where the sharp 4...Nd4 needs theory." },
      { m: "e1g1,h1f1", san: "5.O-O", note: "" },
      { m: "e8g8,h8f8", san: "5...O-O", note: "King safe by move five, again." },
      { m: "d2d3", san: "6.d3", note: "" },
      { m: "d7d6", san: "6...d6", note: "The stable tabiya: next ...Bxc3 (when it doubles his pawns for keeps), ...Ne7-g6, ...c6 kicking the bishop. SF: +0.2 — book equality where he has to prove everything and you know the three plans." },
    ] },
    { t: "3.d4 — your own Scotch, from the other side.", base: ["e2e4","e7e5"], plies: [
      { m: "g1f3", san: "2.Nf3", note: "" },
      { m: "b8c6", san: "2...Nc6", note: "" },
      { m: "d2d4", san: "3.d4", note: "They play YOUR opening at you — 44 of your games, and you scored 48% in positions you know better than anyone. That ends here." },
      { m: "e5d4", san: "3...exd4", note: "The main road — you've taught it from the White side." },
      { m: "f3d4", san: "4.Nxd4", note: "" },
      { m: "g8f6", san: "4...Nf6", note: "The Mieses — YOUR White main line. Every position from here is one you've drilled; only the chair is different. SF: this is Black's co-best and you already know both sides' plans." },
      { m: "d4c6", san: "5.Nxc6", note: "" },
      { m: "b7c6", san: "5...bxc6", note: "The structure you clamp as White — now you defend it, knowing exactly what White wants." },
      { m: "e4e5", san: "6.e5", note: "The clamp attempt you know by heart —" },
      { m: "d8e7", san: "6...Qe7", note: "— and the pin you know is its price." },
      { m: "d1e2", san: "7.Qe2", note: "" },
      { m: "f6d5", san: "7...Nd5", note: "" },
      { m: "c2c4", san: "8.c4", note: "The move you play as White. Now watch its answer —" },
      { m: "c8a6", san: "8...Ba6!", note: "— the resource your own pack calls 'the x-ray'. Pinning c4 to the queen, freeing everything. SF: 0.00, every move of this line engine-perfect. You know White's dreams here (Bb2, Nd2, the clamp) — so you know exactly what to prevent. Mirror knowledge is free strength." },
    ] },
    { t: "2.d4 — the center game.", base: ["e2e4","e7e5"], plies: [
      { m: "d2d4", san: "2.d4", note: "The center game — 32 of your games. He opens the middle before developing anything." },
      { m: "e5d4", san: "2...exd4", note: "Take. The recapture is the whole story —" },
      { m: "d1d4", san: "3.Qxd4", note: "— because 23 of 32 recaptured with the QUEEN. You know this law from your Scandinavian pack, other chair: early queens pay tempo-tax." },
      { m: "b8c6", san: "3...Nc6!", note: "Develop with tempo — the collector arrives." },
      { m: "d4e3", san: "4.Qe3", note: "Her best square — she's still a target there." },
      { m: "g8f6", san: "4...Nf6", note: "" },
      { m: "b1c3", san: "5.Nc3", note: "" },
      { m: "f8b4", san: "5...Bb4!", note: "Pin, develop, threaten — three pieces out to his one-plus-wandering-queen. SF: −0.35, BLACK better on move five." },
      { m: "c1d2", san: "6.Bd2", note: "" },
      { m: "e8g8,h8f8", san: "6...O-O", note: "" },
      { m: "e1c1,a1d1", san: "7.O-O-O", note: "He hides on the queenside —" },
      { m: "f8e8", san: "7...Re8!", note: "— and the e-file gun loads against his e4 pawn and everything behind it. SF: −0.35 with opposite castling and BLACK holding the initiative: ...d5 or ...a5-a4 next, your choice of storm. The tempo-tax law, converted into an attack." },
    ] },
    { t: "2.f4 — the King's Gambit, declined.", base: ["e2e4","e7e5"], plies: [
      { m: "f2f4", san: "2.f4", note: "The King's Gambit — your worst-scoring reply anywhere (37%). The fix is one calm bishop move." },
      { m: "f8c5", san: "2...Bc5!", note: "Decline — and aim straight through f4's hole at his king. The point: 3.fxe5?? now loses to Qh4+ (next line). His gambit needs you greedy; you simply develop.", why: { q: "The engine slightly prefers taking on f4. Why decline?", a: "Accepting is +0.4 better and needs twenty moves of theory to survive; declining is dead solid and carries a built-in refutation of his most natural follow-up. A repertoire optimizes learning-per-minute and blunder-resistance, not the last 40 centipawns — this is a documented, chosen exception to the best-move rule." } },
      { m: "g1f3", san: "3.Nf3", note: "His main (11 of 15): guarding against ...Qh4+." },
      { m: "d7d6", san: "3...d6", note: "Solidify e5, open the bishop's diagonal fully." },
      { m: "c2c3", san: "4.c3", note: "" },
      { m: "g8f6", san: "4...Nf6", note: "Development and center pressure — his f4 is a permanent hole." },
      { m: "d2d4", san: "5.d4", note: "The big-center try —" },
      { m: "e5d4", san: "5...exd4", note: "" },
      { m: "c3d4", san: "6.cxd4", note: "" },
      { m: "c5b6", san: "6...Bb6!", note: "The retreat that retreats nothing: the bishop keeps the exact diagonal, now aimed through d4 at f2 forever. SF: +0.21 only — for a 'gambit' he owns a leaky king, a target on d4 and no attack. ...O-O, ...Ng4 and ...Re8 write themselves." },
    ] },
    { t: "2.f4 — the greedy 3.fxe5??", base: ["e2e4","e7e5","f2f4","f8c5"], plies: [
      { m: "f4e5", san: "3.fxe5??", note: "The natural grab — and the losing move, instantly." },
      { m: "d8h4", san: "3...Qh4+!", note: "The check f4 made possible and Bc5 made safe: his king has no good square." },
      { m: "g2g3", san: "4.g3", note: "The only block —" },
      { m: "h4e4", san: "4...Qxe4+!", note: "— and the fork: check plus the h1 rook. Whatever he blocks with, Qxh1 follows. SF: −3.9 on move four. This is WHY 2...Bc5 was the decline: it turns his most natural move into a lost game." },
    ] },
  ],
  drills: [],
};
...
const FRENCH = {
  id: "french", family: "shield", chip: "🥐 French", badge: "🥐 FRENCH · THE ADVANCE CLAMP · WHITE",
  chunks: { A: "Chunk A · The wall meets the wedge", B: "Chunk B · The base war", C: "Chunk C · The bind holds" },
  chunkGoals: {
    A: "He hides the f7 target behind ...e6. Answer: take the space he offered — e5 cramps his whole kingdom, permanently.",
    B: "Everything he does now attacks your d4 base. Everything you do defends it with development. Count attackers vs defenders every move.",
    C: "One prophylactic pawn move ends the argument: his pressure peaks, achieves nothing, and your space advantage plays the rest of the game.",
  },
  dream: [
    { m: "e2e4", san: "1.e4", chunk: "A", note: "" },
    { m: "e7e6", san: "1...e6", chunk: "A", note: "The French — 48 of your games, and everyone else's games too. Solid, cramped, and honest." },
    { m: "d2d4", san: "2.d4", chunk: "A", note: "The full center, free of charge." },
    { m: "d7d5", san: "2...d5", chunk: "A", note: "The French strike. (Only 44% of club 'French' players actually play this — the Edge cases cover the rest.)" },
    { m: "e4e5", san: "3.e5!", chunk: "A", anchor: true, note: "The advance: lock the center and take the kingside forever.", why: { q: "Pushing releases the tension — why is that good here?", a: "Because HIS whole opening was built to trade on e4, and e5 refuses the trade while entombing his c8 bishop behind its own pawn chain. Space is a long-term asset that cannot be recaptured: his position is now permanently smaller, and his only plan (attack d4) is one you can see coming for the next ten moves." } },
    { m: "c7c5", san: "3...c5", chunk: "B", note: "The book counter — hitting your chain at its base." },
    { m: "c2c3", san: "4.c3", chunk: "B", note: "Reinforce the base before developing. Structure first — the pieces have fixed jobs now." },
    { m: "b8c6", san: "4...Nc6", chunk: "B", note: "Second attacker on d4." },
    { m: "g1f3", san: "5.Nf3", chunk: "B", note: "Second defender — developing WITH the defense." },
    { m: "d8b6", san: "5...Qb6", chunk: "B", note: "Third attacker: the queen joins against d4 and b2. This is the critical French position at every level." },
    { m: "a2a3", san: "6.a3!", chunk: "C", anchor: true, note: "The engine's own first choice, and the quiet point of the whole system.", why: { q: "Everything is attacked and White plays a rook-pawn move. What did it do?", a: "Two things at once: it takes b4 away from his pieces forever (no ...cxd4 cxd4 Bb4+ tricks, no ...Nb4), and it prepares b4 for YOU — gaining queenside space where he thought he was attacking. His pressure on d4 has peaked; yours is only starting. Prophylaxis is an attack on his PLANS instead of his pieces. SF d53: +0.22 and every plan on the board is White's." } },
  ],
  promise: {
    eyebrow: "The promise · move 6", headline: "His whole army hits d4. Nothing falls.",
    plyCount: 11, last: ["a2", "a3"], marks: ["d4", "e5"],
    body: "Before you learn a single move: three Black pieces attack your center and it is completely safe — while his c8 bishop is buried for the whole game. Can you see who is actually winning this argument?",
    revealTitle: "6.a3!",
    reveal: "Count d4: attacked three times, defended three times, and reinforceable (Be3, b4-with-tempo) faster than he can add attackers. Meanwhile e5 fixes his kingside forever and the c8 bishop stares at its own e6 pawn. The French trades activity for solidity — the advance takes the solidity too.",
    chip: "The French is the second most common defense you face. One system answers all of it.",
  },
  danger: {
    eyebrow: "The edge case · the fake French", headline: "2...d6 — the wall without the strike.",
    base: ["e2e4","e7e6","d2d4"], baseCount: null,
    plies: [
      { m: "d7d6", san: "2...d6", note: "The half-French: he never plays ...d5, so you keep BOTH center pawns free." },
      { m: "g1f3", san: "3.Nf3", note: "" },
      { m: "g8f6", san: "3...Nf6", note: "" },
      { m: "b1c3", san: "4.Nc3", note: "" },
      { m: "f8e7", san: "4...Be7", note: "" },
      { m: "f1d3", san: "5.Bd3", note: "The full classical setup: the biggest legal center, every piece on its best square, O-O next. SF: +0.5 with nothing to calculate — passive walls lose by being smaller, slowly, forever." },
    ],
    ledgerTitle: "What 'French' players actually do after 2.d4",
    ledger: [
      { label: "2...d5 — the real French", pct: 44, color: C.gold },
      { label: "2...d6 / slow walls", pct: 20, color: C.red },
      { label: "Other (...Qh4?!, ...Nf6, scatter)", pct: 36, color: C.muted },
    ],
    survivalTitle: "Against the scatter",
    survival: "Anything that isn't ...d5 gets the same recipe as the fake French: both center pawns, knights to f3/c3, Bd3, castle. Against 3...Nc6 (attacking d4 early): 4.Nf3 and the base war from the dream line, one tempo up. The French only bites when ...d5 comes — no ...d5, no French.",
    bailoutTitle: "The one rule",
    bailoutMoves: ["e2e4","e7e6","d2d4","d7d5","e4e5"],
    bailoutLast: ["e4", "e5"],
    bailoutNote: "Advance, reinforce, develop behind the wedge: e5–c3–Nf3–a3–Be2/Bd3. The move order barely matters; the structure is the repertoire.",
  },
  drills: [
    { id: "fr1", kind: "move", plyCount: 4, from: "e4", to: "e5",
      prompt: "He struck with 2...d5. Refuse the argument.",
      hints: ["His opening exists to trade on e4.", "Take the space that can never be taken back."],
      reason: "3.e5! — the advance: his bishop is buried, your kingside space is permanent." },
    { id: "fr2", kind: "move", plyCount: 10, from: "a2", to: "a3",
      prompt: "Queen, knight and pawn all hit d4. Find the quiet answer.",
      hints: ["Whose PLANS can you attack, rather than whose pieces?", "Take away b4 — then take b4."],
      reason: "6.a3! — prophylaxis plus expansion: his pressure has peaked, yours is starting." },
    { id: "fr3", kind: "goal",
      prompt: "What does the advance 3.e5 actually buy?",
      options: [
        "Permanent space and a buried c8 bishop — assets that survive every trade and never need defending",
        "A kingside pawn storm",
        "A direct attack on f7",
      ], correct: 0,
      reason: "Space is the only advantage that cannot be recaptured. This idea runs every closed opening you'll ever play." },
  ],
};

const RARE = {
  id: "rare", family: "shield", chip: "🧭 Rare replies", badge: "🧭 RARE REPLIES · ONE RECIPE · WHITE",
  chunks: { A: "Chunk A · The center, uncontested", B: "Chunk B · Classical development", C: "Chunk C · The slow squeeze" },
  chunkGoals: {
    A: "He declines the center fight entirely (…d6, …g6, …b6, …Nc6). Answer every one of them the same way: take the whole middle.",
    B: "Develop to the natural squares behind the big center — the setup is identical against all of them, which is the entire point.",
    C: "Castle, then squeeze: your space means his pieces obstruct each other. No tactics needed until his position asks for them.",
  },
  dream: [
    { m: "e2e4", san: "1.e4", chunk: "A", note: "" },
    { m: "d7d6", san: "1...d6", chunk: "A", note: "The Pirc-style wall — the most common of the rare replies (21 of your games, and your worst score among them)." },
    { m: "d2d4", san: "2.d4", chunk: "A", note: "Both center pawns, unopposed. Whatever he was planning, it starts a tempo down now." },
    { m: "g8f6", san: "2...Nf6", chunk: "A", note: "His main move (13 of 21 in your games)." },
    { m: "b1c3", san: "3.Nc3", chunk: "B", note: "Guard e4 by developing — never f3 or Bd3 first." },
    { m: "g7g6", san: "3...g6", chunk: "B", note: "The fianchetto — the standard Pirc plan." },
    { m: "g1f3", san: "4.Nf3", chunk: "B", note: "The classical answer: no theory war, just better squares. (4.f4, the Austrian, is sharper — and unnecessary.)" },
    { m: "f8g7", san: "4...Bg7", chunk: "B", note: "" },
    { m: "f1e2", san: "5.Be2", chunk: "C", note: "Modest and right: the bishop supports the coming O-O and keeps d3/f3 free for the pieces that want them." },
    { m: "e8g8,h8f8", san: "5...O-O", chunk: "C", note: "" },
    { m: "e1g1,h1f1", san: "6.O-O", chunk: "C", anchor: true, note: "The classical tabiya. SF d44: +0.44 with zero risk — now Re1, h3, and the e5-break when his pieces are furthest away. He has one plan (...e5 or ...c5); you see both coming.", why: { q: "Where is White's advantage, concretely?", a: "In the OPTIONS: every Black piece has one square and one job (the g7 bishop stares at your c3/d4 wall), while every White piece has two futures. Space advantages are option advantages — you win by having more reasonable moves every turn until his position runs out of them. This recipe answers every passive first move in chess." } },
  ],
  promise: {
    eyebrow: "The promise · move 6", headline: "Every rare reply, one answer.",
    plyCount: 11, last: ["e1", "g1"], marks: ["d4", "e4"],
    body: "Before you learn a single move: this is the position after ANY passive first move — ...d6, ...g6, ...b6 — if you follow one recipe. White is simply better. What is the recipe?",
    revealTitle: "The full center",
    reveal: "e4+d4, knights to c3/f3, Be2 (or Bd3 when the long diagonal needs contesting), castle. Six moves, identical against every wall. The rare replies bet that you don't have a plan against them — the recipe IS the plan, and it needs no memory beyond this one line.",
    chip: "…d6, …Nc6, …g6 and …b6 together are ~7% of your games — one line covers all of them.",
  },
  danger: {
    eyebrow: "The edge case · 1...Nc6", headline: "The knight first — invite it to transpose.",
    base: ["e2e4"], baseCount: null,
    plies: [
      { m: "b8c6", san: "1...Nc6", note: "The Nimzowitsch — trying to drag you somewhere strange." },
      { m: "g1f3", san: "2.Nf3!", note: "The refusal: now 2...e5 transposes straight into your Scotch book — he gets YOUR opening for his trouble.", why: { q: "Why not just 2.d4, the 'main line'?", a: "Because 2.d4 d5! is the one line where his oddity has real teeth, and it's HIS preparation, not yours. 2.Nf3 offers him two futures: transpose into the book you know best, or play the passive ...d6 below. Move orders are weapons: choose the one where every branch lands in YOUR repertoire." } },
      { m: "d7d6", san: "2...d6", note: "The independent try —" },
      { m: "d2d4", san: "3.d4", note: "— and the recipe resumes: full center, a tempo ahead of the Pirc version." },
      { m: "g8f6", san: "3...Nf6", note: "" },
      { m: "b1c3", san: "4.Nc3", note: "" },
      { m: "c8g4", san: "4...Bg4", note: "His only active idea: the pin." },
      { m: "c1e3", san: "5.Be3", note: "Break no rules: develop, keep d4 solid, ask the pin to prove itself (h3 comes with tempo whenever you want). SF: +0.6 — the knight tour bought him nothing." },
    ],
    ledgerTitle: "The rare replies in your games",
    ledger: [
      { label: "1...d6 — the wall (worst score: 38%)", pct: 33, color: C.red },
      { label: "1...Nc6 — the Nimzowitsch", pct: 27, color: C.gold },
      { label: "1...g6 / 1...b6 — the fianchettos", pct: 40, color: C.muted },
    ],
    survivalTitle: "The recipe, stated once",
    survival: "Full center (e4+d4), knights c3/f3, bishop e2 (d3 when his bishop went to b7), castle short, THEN pick a break (e5 or f4) aimed where his pieces aren't. Works against every first move that doesn't contest the center — which is what makes rare replies rare.",
    bailoutTitle: "The one rule",
    bailoutMoves: ["e2e4","d7d6","d2d4"],
    bailoutLast: ["d2", "d4"],
    bailoutNote: "If in doubt against ANY strange move: take the second center square and develop classically. You cannot be punished for the full center by a player who declined to fight for it.",
  },
  lines: [
    { t: "1...g6 — the modern, met by the 150 setup.", base: ["e2e4"], plies: [
      { m: "g7g6", san: "1...g6", note: "The modern: he'll fianchetto and dare you to have a plan." },
      { m: "d2d4", san: "2.d4", note: "" },
      { m: "f8g7", san: "2...Bg7", note: "" },
      { m: "b1c3", san: "3.Nc3", note: "" },
      { m: "d7d6", san: "3...d6", note: "" },
      { m: "c1e3", san: "4.Be3", note: "The 150 Attack begins: Be3+Qd2 aims Bh6 at his best piece." },
      { m: "g8f6", san: "4...Nf6", note: "" },
      { m: "d1d2", san: "5.Qd2!", note: "The setup complete: Bh6 trades his only proud bishop, O-O-O follows, and the h-pawn knows the road. Named the '150 Attack' because ~1800-graded players beat grandmasters' openings with it — it is that independent of theory. SF: +0.49." },
    ] },
    { t: "1...b6 — the owl, met with the good diagonal.", base: ["e2e4"], plies: [
      { m: "b7b6", san: "1...b6", note: "Owen's defense: the bishop will peck at e4 from b7." },
      { m: "d2d4", san: "2.d4", note: "" },
      { m: "c8b7", san: "2...Bb7", note: "" },
      { m: "f1d3", san: "3.Bd3!", note: "The one adjustment to the recipe: your bishop takes the SAME diagonal his wants — but yours stands in front of a pawn duo and his stares into it. Same diagonal, unequal lives." },
      { m: "e7e6", san: "3...e6", note: "" },
      { m: "g1f3", san: "4.Nf3", note: "Recipe resumed: c3 next, castle, and his setup depends on breaks (...c5/...f5) that open the position for YOUR better pieces. SF: +0.73 — the largest move-4 advantage any reply concedes you." },
    ] },
  ],
};
...
const PACKS = [MIESES, CLASSICAL, STEINITZ, HOOVER, DECLINES, SCOTCH, GRECO, MOLLER, SPEAR, LANGE, FRIED, LEGAL, MIRROR, HALLO, ALIEN, MORRA, PETROFF, RUSSIAN, PHILIDOR, HANHAM, SCANDI, FRENCH, RARE, KPAWN, QPAWN, BUSCH];
...
const EXTRAS = {
  ...
  morra: {
    ...
    futures: [
      ...
      { t: "He saves the rook", moves: [
          { m: "h8g8", san: "10...Rg8" },
          { m: "f7g5", san: "11.Ng5!" } ],
        note: "The knight retreats WITH its profit: the f7 pawn is banked, material is level while his king is stuck in the center forever, and Ne6/Qh5 threats keep coming — SF: +0.6 and only White has plans. (The greedy 11.Nxe5? — one more pawn — is the only LOSING move here: 11...Nxe5 wins a piece. The deep audit caught it; retreat-with-profit beats grab-and-hope.)" },
    ],
  },
  fried: {
    hints: {
  ...
  french: {
    hints: {
      A: "Advance, don't trade: e5 is a purchase of permanent space. His light-squared bishop pays for it forever.",
      B: "d4 is a math problem: count attackers and defenders after every move, and add defenders by developing.",
      C: "a3 first, then Be2 and O-O at leisure. When the d4 pressure peaks and fails, the rest of the board is yours.",
    },
    finalWhy: "His maximum pressure achieved nothing: d4 stands, b4 is White's square now, the c8 bishop is a wall ornament, and the e5 wedge divides his board in two. Space plus a locked bad bishop is an endgame advantage already — everything that gets traded makes it bigger.",
    futures: [],
  },
  rare: {
    hints: {
      A: "Both center pawns, always — passive first moves have no punishment for the full center.",
      B: "Knights before bishops, e2 before adventures. The recipe's power is that it needs no thought.",
      C: "Castle, improve the worst piece, and only then choose a break. Space wins by patience, not by force.",
    },
    finalWhy: "One setup, four openings answered: every Black piece has a single square and a single hope, while yours all have spares. Option advantages convert themselves — keep making the most natural move and his position runs out of ideas first.",
    futures: [],
  },
  petroff: {
    hints: {
...
const LEARNABLE_PACK_IDS = ["petroff", "russian", "philidor", "hanham", "scandi", "alien", "morra", "french", "rare"]; // shield packs learnable into the gauntlet
